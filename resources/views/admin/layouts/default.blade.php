...
<body>
<div>
    <nav class="d-lg-none navbar navbar-light bg-white border-bottom">
        <div class="container-fluid">
            <a class="d-inline-block h3 mb-0 text-decoration-none text-white" href="#">
                <img src="sirius-assets/images/logos/sirius-logo.svg" alt="" width="96px">
            </a>
    ...
    <div class="position-relative navbar-menu d-none d-lg-block" style="z-index: 9999;">
        ...
        <div class="position-fixed top-0 start-0 bottom-0 col-8 mw-xs px-6 pt-8 pb-8 bg-white border-end overflow-auto">
            <a class="d-inline-block h3 mb-10 text-decoration-none" href="#">
                <img src="sirius-assets/images/logos/sirius-logo.svg" alt="" width="96px">
            </a>
            <div class="mb-10 p-4 border border-secondary shadow rounded-2 position-relative">
                <div class="d-flex align-items-center">
                    <img class="me-4 rounded-2" src="sirius-assets/images/photos/twitch.svg" alt="" height="40">
                    <div>
                        <p class="fw-bold text-dark mb-0">Twitch</p>
                        <p class="mb-0">Workspace</p>
                    </div>
                </div>
                <select class="position-absolute top-0 start-0 bottom-0 end-0 form-select bg-transparent border-0" name="" id="">
                    <option value=""></option>
                </select>
            </div>
            <ul class="mb-8 mb-md-24 list-unstyled">
                <li class="mb-2">
                    <a class="d-flex py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#">
                        <svg class="me-3" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M16.8737 16.875V9.02647C16.8737 8.93939 16.8555 8.85327 16.8202 8.77363C16.785 8.69399 16.7335 8.62259 16.6691 8.56402L10.4187 2.88159C10.3036 2.77699 10.1537 2.71903 9.99821 2.71904C9.84272 2.71905 9.69281 2.77701 9.57777 2.88161L3.3282 8.56402C3.26377 8.6226 3.2123 8.69399 3.17707 8.77362C3.14185 8.85326 3.12366 8.93937 3.12366 9.02645V16.875" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M1.24866 16.875H18.7487" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M11.8732 16.8743V12.4993C11.8732 12.3336 11.8073 12.1746 11.6901 12.0574C11.5729 11.9402 11.4139 11.8743 11.2482 11.8743H8.74817C8.58241 11.8743 8.42344 11.9402 8.30623 12.0574C8.18902 12.1746 8.12317 12.3336 8.12317 12.4993V16.8743" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                        <span>Home</span>
                    </a>
                </li>
                ...
                <li class="mb-2">
                    <a class="d-flex py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#" data-bs-toggle="collapse" data-bs-target="#menus2-1">
                        <svg class="me-3" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <svg width="10" height="7" viewbox="0 0 10 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.75 1.5L5 5.25L1.25 1.5" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                    ...
                    <div class="collapse ps-6" id="menus2-1">
                        <a class="d-flex mb-2 py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#">
                            <svg class="me-3" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="mb-2">
                    <a class="d-flex py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#">
                        ...
                        <span>Inbox</span>
                        <span class="py-1 px-2 ms-auto bg-danger text-white rounded-pill">99+</span>
                    </a>
                </li>
                <li class="mb-2">
                    <a class="d-flex py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#">
                ...
                <li class="mb-2">
                    <a class="d-flex py-3 px-4 align-items-center text-decoration-none text-muted fw-bold" href="#">
                        <svg class="me-3" width="20" height="20" viewbox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 17.5C14.1421 17.5 17.5 14.1421 17.5 10C17.5 5.85786 14.1421 2.5 10 2.5C5.85786 2.5 2.5 5.85786 2.5 10C2.5 14.1421 5.85786 17.5 10 17.5Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M10 13.125C11.7259 13.125 13.125 11.7259 13.125 10C13.125 8.27411 11.7259 6.875 10 6.875C8.27411 6.875 6.875 8.27411 6.875 10C6.875 11.7259 8.27411 13.125 10 13.125Z" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M7.79037 7.79028L4.69678 4.69669" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M12.2097 7.79028L15.3033 4.69669" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M12.2097 12.2097L15.3033 15.3033" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M7.79037 12.2097L4.69678 15.3033" stroke="#7A899B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                        <span>Support</span>
                    </a>
                </li>
