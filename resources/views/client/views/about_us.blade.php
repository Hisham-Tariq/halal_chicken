            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-xxl-5 col-lg-9 mt-35 mt-xl-0">
                        ...
                        <p class="mt-n2 mb-4">Assertively envisioneer high-payoff architectures after interactive service. Collaboratively whiteboard pandemic intellectual capital without cross-platform channels.</p>
                        <div class="checklist-wrap">
                            <div class="as-video">
                                <img src="assets/img/normal/about_1_2.jpg" alt="video">
                        ...
                        <div class="btn-wrap">
                            ...
                            <div class="profile-box">
                                ...
                                <div class="content">
                                    <h6 class="title">David Jordan</h6>
                                    <p class="desig">CEO, of Pizzer Company</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-xl-5 space-top space-xl">
                    <div class="title-area mb-30">
                        ...
                        <h2 class="sec-title">The Pizzer Has Excellent Of <span class="font-style text-theme">Quality Foods</span></h2>
                    </div>
                    <p class="mt-n2 mb-20">Compellingly supply professional material rather than out-of-the-box process improvements. Phosfluorescently communicate premium mindshare and extensive imperatives. Dynamically fashion.</p>
                    <p class="mb-4">Seamlessly conceptualize sticky functionalities after prospective data. Interactively unleash customized supply chains whereas goal oriented paradigm. Credibly reintermediate client-focused model for.</p>
...
<section class="z-index-common space-top" style="background-color: rgba(0, 0, 0, 0.8)">
    <div class="container" data-pos-space="#testiSec1" data-sec-space="margin-bottom" data-margin-bottom="170px">
        <div class="title-area text-center">
            ...
            <h2 class="sec-title">Meet Our Expart <span class="font-style text-theme">Chefs</span></h2>
